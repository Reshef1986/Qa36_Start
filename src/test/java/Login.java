...
public class Login {
    ...
    public void ccslocatrstest() {
        ...
        wd.findElement(By.cssSelector(" [name='login' ]"));// не то так как это атрибут и значение а не тагнейм элемента
        wd.findElement(By.cssSelector("[name = 'registration']"));//// не то так как это атрибут и значение а не тагнейм элемента
 ...
 */
        ...
        //На странице логин найти  элемент с  атрибутом placeholder, значение которое  содержит  "ass"
